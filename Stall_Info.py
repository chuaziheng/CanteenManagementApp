...
class Ui_StallInfo(object):
    ...
    #Function to display menu on Monday
    ...
    def displayMenu1(self):
        ...
        if index == 3 :
            ...
            self.breakfast.setPalette(palette)
    ...
    #Function to display menu on Tuesday
    #Done by Andrew Wiraatmaja
    ...
    #Function to display menu on Wednesday
    #Done by Andrew Wiraatmaja
    ...
    #Function to display menu on Thursday
    #Done by Andrew Wiraatmaja
    ...
    #Function to display menu on Friday
    #Done by Andrew Wiraatmaja
    ...
    #Function to display menu on Saturday
    #Done by Andrew Wiraatmaja
    ...
    #Function to display menu on Sunday
    #Done by Andrew Wiraatmaja
    ...
    #Function to display stall name, description, logo, halalness
    #Done by Andrew Wiraatmaja
    def displayStall(self):
        ...
        dayy = (calendar.weekday(year,month,day))%7
        ...
        self.prep_time.setText(str(float(db[index].prep_time))+" minutes")
        self.prep_time.show()
    ...
    def setupUi(self, FirstWindow):
        ...
        self.change_time.setGeometry(QtCore.QRect(420, 220, 171, 41))
        palette = QtGui.QPalette()
