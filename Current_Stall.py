...
class Ui_CurrentStall(object):
    ...
    #Function to display stall name, logo, description
    ...
    def displayStall(self):
        ...
        self.prep_time.setText(str(float(today_db[index].prep_time))+" minutes")
        self.prep_time.show()
        if today_db[index].halal == True:
    ...
    #Function to open Check_Queue file
    #Done by Andrew Wiraatmaja
    def openWindow(self):
